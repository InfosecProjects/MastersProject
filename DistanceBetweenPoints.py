NOTE:
modified version of https://github.com/ayeowch/traceroute
...
class Traceroute(object):
    ...
    def get_geocoded_hops(self, hops):
		...
		list2 = [location['latitude'],location['longitude']]
		print(list2)
		#mylist.append(7)
		mylist.append(list2)
...
def main():
    ...
    Gmap3 = gmplot.GoogleMapPlotter(mylist[0][0], mylist[0][1],13)
    for x in range(0,len(mylist)):
	Lats.append(mylist[x][0])
        Longs.append(mylist[x][1])
    Gmap3.apikey = "XXXXX"

    print(Lats)
    print(Longs)
    Gmap3.scatter(Lats, Longs ,'# FF0000', size = 40, marker = True )
    Gmap3.plot(Lats, Longs, 'cornflowerblue', edge_width = 2.5) 
    Gmap3.draw('/Users/gmapnew.html')
